...
public interface AuthenticationSessionService {
    ...
    AuthenticationSession getMeSession(HttpServletRequest httpServletRequest) throws AuthenticationSession.SessionRequestBadHeaderException, AuthenticationSession.SessionNotFoundException;
}
